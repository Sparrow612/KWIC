 ...
 */
  ...
  public void execute(String file){
    LineStorage input_lines=new LineStorage();
    new Input().parse(file, input_lines);
    CircularShifter shifts=new CircularShifter();
    shifts.setup(input_lines);
    Alphabetizer alphabetizer=new Alphabetizer();
    alphabetizer.alpha(shifts);
    new Output().print(alphabetizer);
  }
